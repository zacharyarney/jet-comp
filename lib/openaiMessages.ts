...
export interface ComparisonRequest {
  planes: Jet[];
  metric: 'top speed' | 'fuel efficiency' | 'max seats';
}
...
export function userMessage(input: ComparisonRequest): ChatCompletionMessageParam {
...
- ${planes}
Your response should be a JSON object where the data is an array of objects representing the planes in their ranked order. The plane objects should be formatted like this:
{
    name: string,
    rank: number,
    value: string
